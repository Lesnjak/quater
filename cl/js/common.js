...
//     cursorcolor:'#6bad02'
// });
 $('.logo, .close-form ').click(function () {
     $('.main-block').css('display','block');
     $('.form-section').css('display','none');
 })
    // $('.sheme').click(function(){
    //     $('html, body').animate({scrollTop:$('#sheme').position().top}, 2000);
    //     return false
    // });
...
$('.form-group ').submit(function (event) {
    ...
    if(inputName && inputEmail && inputCompany  && patternEmail.test(inputEmail)){
        ...
        //     site=f.site.value;
        // }
        // http.open("POST", "http://cl.zpz.dp.ua/contacts.php", true);
        // http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
